...
$translation = array (
  ...
  'install_script.error_message_1' => 'The root folder of your installed X-Cart store still contains the file install.php that is used to launch X-Cart installation. Keeping this file in the said location \'as is\' is not secure. We strongly recommend that this file should be deleted or renamed to prevent unauthorized access to the store installation tools.',
  'php_version.error_message_1' => 'PHP Version must be at least :minPhpVersion.',
  'php_version.error_message_2' => 'PHP Version must be not greater than :maxPhpVersion.',
  'php_version.error_message_3' => 'Unsupported PHP version detected.',
  'PHP option sql.safe_mode value should be Off' => 'PHP option sql.safe_mode must be set to Off',
  'Unlimited' => 'Unlimited',
  'php_memory_limit.error_message_1' => 'PHP memory_limit option must be at least :memoryLimitMin.',
  'php_file_uploads.error_message_1' => 'PHP file_uploads option must be set to On.',
  'Support MySQL is disabled in PHP. It must be enabled.' => 'MySQL support is disabled in PHP. It must be enabled.',
  'php_pdo_mysql.error_message_1' => 'PDO extension with MySQL support must be installed.',
  'php_upload_max_file_size.error_message_1' => 'PHP option upload_max_filesize must contain a value. It is currently empty.',
  ...
  'mysql_version.error_message_1' => 'MySQL version must be at least :minMysqlVersion.',
  'mysql_version.error_message_3' => 'Cannot get MySQL server version (:error).',
  'php_gdlib.error_message_1' => 'GDlib extension v.2.0 or later is required for some modules.',
...
',
  ...
  'kb_note_mysql_issue' => 'More information on ways to resolve problems with MySQL connection is available in our <a href="https://kb.x-cart.com/en/general_setup/installation_guide.html#problems-with-connection-to-database" target="_blank">Knowledge Base</a>.',
  ...
  'file_permissions.error_message_1' => 'Not enough permissions to run the process. Please make sure the following files are writable:' . PHP_EOL . '<br /><i class="copy2clipboard fa fa-clipboard"></i><div class="copy2clipboard-alert alert-success" style="display: none;"></div><div class="permissions-list">:pathsList</div>',
  'file_permissions.error_message_2' => 'Not enough permissions to run the process. Make sure the following permissions are set (UNIX-like systems only):' . PHP_EOL . '<br /><i class="copy2clipboard fa fa-clipboard"></i><div class="copy2clipboard-alert alert-success" style="display: none;"></div><div class="permissions-list">:pathsList</div>' . PHP_EOL . 'Such permissions are required for a seamless automated installation or upgrade of X-Cart on your server. They do not take into account the specific configuration of your server or any security requirements. Once the process is completed, make sure you change the permissions to a more restrictive setting. <a target="_blank" href="https://kb.x-cart.com/en/setting_up_x-cart_5_environment/secure_configuration.html#why-x-cart-asks-for-666777-permissions">Read more</a>',
  ...
  'I accept the License Agreement' => 'I accept the License Agreement and the <a href="https://www.x-cart.com/privacy-policy.html?utm_source=XC5Install&utm_medium=acceptLA&utm_campaign=XC5Install" target="_blank">Privacy policy</a>',
  ...
  'php_version.label_message' => 'PHP versions <b>5.4.0+</b> are currently supported.',
  'php_disabled_functions.label_message' => 'Some functions, used by X-Cart, are found disabled. Make sure that these functions are not listed in "disable_functions" option and all php extensions required for these functions availability are enabled in the php.ini file. Please correct this and try again.',
  'php_memory_limit.label_message' => 'PHP memory_limit option must be at least :memoryLimitMin.',
  'php_pdo_mysql.label_message' => 'PDO extension with enabled MySQL support is used by X-Cart for connecting to the database. Please make sure this extension is loaded in your php.ini file and try again.',
  'php_file_uploads.label_message' => 'The configuration of the server where X-Cart will be installed meets the Server requirements; however, some server software issues, which can impair X-Cart operation, have been identified on the server.<br /><br />For proper operation of X-Cart the value of the upload_max_filesize variable in the php.ini file should indicate the maximum file size allowed for upload.',
  'php_upload_max_file_size.label_message' => 'For proper operation of X-Cart the value of the upload_max_filesize option in the php.ini file should indicate the maximum file size allowed for upload. Please correct this option or contact your hosting provider\'s support to have the parameter adjusted.',
  'php_gdlib.label_message' => 'GDLib 2.0 or better is required for automatic generation of product thumbnails form product images and for some other modules. GDLib must be compiled with libJpeg (ensure that PHP is configured with option --with-jpeg-dir=DIR, where DIR is the directory where libJpeg is installed). Please contact the support services of your hosting provider to have the parameter adjusted.',
  'php_phar.label_message' => 'Phar extension is required for installation of external X-Cart addons and upgrades from the Marketplace.  Phar v.2.0.1 or later is recommended, otherwise this features may fail to work properly. Please contact your hosting provider\'s support to have this parameter adjusted.',
  'https_bouncer.label_message' => 'The libCURL module with HTTPS protocol support and a valid SSL certificate is required for credit cards processing via Authorize.NET, PayPal or other payment gateways and using real-time shipping calculation services (these services require your website to accept secure connections via HTTPS/SSL). Please contact your hosting provider\'s support to have these parameters adjusted.',
  'xml_support.label_message' => 'Xml/EXPAT and DOMDocument extensions for PHP are required for using real-time shipping modules and payment modules. Please contact your hosting provider\'s support to have these parameters adjusted.',
  'DocBlocks support' => 'DocBlocks support',
  'doc_blocks_support.error_message_1' => 'The DocBlock feature is not supported by your PHP. This feature is required for X-Cart operation.',
  'doc_blocks_support.error_message_2' => 'The DocBlock feature is not supported by your PHP. This feature is required for X-Cart operation. The cause of DocBlock feature being blocked may be the eAccelerator extension. Disable this extension and try again.',
  'doc_blocks_support.label_message' => 'The Docblocks comments are used in X-Cart and should not be stripped out by any PHP extensions.<br /><br />If the eAccelerator extension is loaded, unload it in php.ini file or reconfigure eAccelerator with the --with-eaccelerator-doc-comment-inclusion switch, then clean the eAccelerator cache directory.',
  'file_permissions.kb_message' => 'Check our <a href="https://kb.x-cart.com/en/general_setup/installation_guide.html#permissionchecking-failed" target="_blank">Knowledge Base</a> in order to find out how to solve the problem with incorrect permissions.',
  'php_disable_functions.kb_message' => 'Check our <a href="https://kb.x-cart.com/en/general_setup/installation_guide.html#disabled-functions" target="_blank">Knowledge Base</a> in order to find out how to solve the problem with disabled PHP functions.',
  'php_pdo_mysql.kb_message' => 'Check our <a href="https://kb.x-cart.com/en/general_setup/installation_guide.html#disabled-php-extensions" target="_blank">Knowledge Base</a> in order to find out how to solve the problem with PDO extension.',
  'https_bouncer.kb_message' => 'Check our <a href="https://kb.x-cart.com/en/general_setup/installation_guide.html#https-bouncer-is-not-installed" target="_blank">Knowledge Base</a> in order to find out how to solve the problem with libCurl library.',
  ...
  'config_file.label_message' => 'Config file does not exist and cannot be copied from the default config file. It is required for the installation.<br /><br />Please, follow these steps: <br /><br />1. Go to directory :configPath<br />2. Copy <i>:defaultConfigFileName</i> to <i>:configFileName</i><br />3. Set writeable permissions on <i>:configFileName</i><br /><br />Then try again.',
  'Oops! Cache rebuild failed.' => 'Oops! Cache rebuilding failed.',
  'Check for possible reasons <a href="https://kb.x-cart.com/pages/viewpage.action?pageId=7504578">here</a>.' => 'Check for possible reasons <a href="https://kb.x-cart.com/en/setting_up_x-cart_5_environment/setting_time_limit_of_your_server.html" target="_blank" >here</a>.',
  ...
  'xcart_site' => 'https://www.x-cart.com/?utm_source=XC5Install&utm_medium=installFooter&utm_campaign=XC5Install',
  ...
  'php_disabled_functions.error_message_1' => 'The following functions are disabled:<br/>:missedFunctions<br/>These functions may be used by the software in some cases and should be enabled.',
  'mysql_version.error_message_2' => 'InnoDB engine is not supported by MySQL server. InnoDB is required for X-Cart operation.',
  'mysql_cache.error_message_1' => 'MySQL query cache is not enabled. See <a href="https://dev.mysql.com/doc/refman/5.7/en/query-cache-configuration.html" target="_blank">https://dev.mysql.com/doc/refman/5.7/en/query-cache-configuration.html</a> for how to enable it.',
  'php_gdlib.error_message_2' => 'GDlib extension does not have the JPEG plugin.',
  'php_phar.error_message_1' => 'Phar extension v.2.0.1 or later is required to get upgrades and install modules; otherwise, these features may not work properly.',
  'frame_options.error_message_1' => 'Your server X-Frame-Options header is configured to DENY. This option is required to be set to SAMEORIGIN or ALLOW-FROM xcart_host for X-Cart installation process. You can set it back to DENY after X-Cart is installed.',
  'frame_options.label_message' => 'The X-Frame-Options server header can be configured to deny opening of the site pages in iframe tags. <br><br>Your server X-Frame-Options header is configured to <b>DENY</b>.<br>This option is required to be set to <b>SAMEORIGIN</b> or <b>ALLOW-FROM xcart_host</b> for a successful X-Cart installation process. You can set it back to <b>DENY</b> after X-Cart is installed.',
);
