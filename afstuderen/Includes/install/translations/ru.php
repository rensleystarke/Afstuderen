...
$translation = array (
  ...
  'install_script.error_message_1' => 'В корневой папке Вашего установленного магазина X-Cart обнаружен файл install.php, используемого для запуска установки X-Cart. Хранение данного файла в указанном местоположеннии в неизменном виде не безопасно. Мы настоятельно рекомендуем удалить или переименовать данный файл для предотвращения неавторизованного доступа к инструментарию инсталляции магазина.',
  ...
  'mysql_version.error_message_1' => 'Версия MySQL должна быть как минимум :minMysqlVersion.',
...
',
  ...
  'php_version.label_message' => 'Версии PHP <b>5.4.0+</b> поддерживаются.',
  ...
  'php_pdo_mysql.label_message' => 'При поддержке MySQL,  расширение PDO необходимо для подклчения X‑Cart 5 к базе данных. Пожалуйста, убедитесь, что это расширение включено в файле php.ini, и попробуйте еще раз.',
  ...
  'Check for possible reasons <a href="https://kb.x-cart.com/pages/viewpage.action?pageId=7504578">here</a>.' => 'Проверьте возможные причины <a href="https://kb.x-cart.ru/setting_up_x-cart_5_environment/setting_time_limit_of_your_server.html" target="_blank" >здесь</a>.',
  ...
  'mysql_cache.error_message_1' => 'Не включен кэш MySQL. Инструкция по включению доступна по ссылке <a href="https://dev.mysql.com/doc/refman/5.7/en/query-cache-configuration.html" target="_blank">https://dev.mysql.com/doc/refman/5.7/en/query-cache-configuration.html</a>.',
