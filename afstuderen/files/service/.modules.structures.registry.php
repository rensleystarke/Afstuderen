...
XC\FreeShipping:
    tables: {  }
    columns: { shipping_methods: { free: 'free TINYINT(1) NOT NULL' }, products: { freeShip: 'freeShip TINYINT(1) NOT NULL', freightFixedFee: 'freightFixedFee NUMERIC(14, 4) NOT NULL' } }
    dependencies: {  }
XC\MailChimp:
