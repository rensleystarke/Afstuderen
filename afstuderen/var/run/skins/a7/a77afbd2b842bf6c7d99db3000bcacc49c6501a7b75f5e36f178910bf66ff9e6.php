...
";
        // line 7
        if ((($this->getAttribute($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "field", array()), "name", array()) == "use_smtp") && $this->getAttribute((isset($context["this"]) ? $context["this"] : null), "isQueuesNoteVisible", array(), "method"))) {
            // line 8
            echo "    <p class=\"help-block not-padded\">";
...
/*  #}*/
/* */
/* {% if this.field.name == 'use_smtp' and this.isQueuesNoteVisible() %}*/
/*     <p class="help-block not-padded">{{ t('To send email asynchronously and improve website performance we recommend to set up queues in on your server. [Learn how to do it].', {'url': 'https://kb.x-cart.com/en/general_setup/configuring_queues.html'})|raw }}</p>*/
/* {% endif %}*/
