...
/* signin/signin.twig */
class __TwigTemplate_a1c305bd809fa102ff9510b17be828d4c581a8c236a7e7c9244bac66419f1e25 extends \XLite\Core\Templating\Twig\Template
{
...
echo $templateWrapperStart;
        ...
        // line 9
        $this->loadTemplate("signin/parts/login.heading.twig", "signin/signin.twig", 9)->display($context);
        if ($templateWrapperText) {
...
echo $templateWrapperStart;
        ...
        // line 29
        $this->loadTemplate("signin/parts/anonymous.heading.twig", "signin/signin.twig", 29)->display($context);
        if ($templateWrapperText) {
            echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
        }
        // line 30
