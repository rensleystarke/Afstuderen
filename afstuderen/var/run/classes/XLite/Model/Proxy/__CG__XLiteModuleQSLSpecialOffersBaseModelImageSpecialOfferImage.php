...
class Image extends \XLite\Module\QSL\SpecialOffersBase\Model\Image\SpecialOffer\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'specialOffer', 'width', 'height', 'hash', 'needProcess', 'includeFilenameInHash', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError', 'loadErrorMessage', '_previous_state');
        }
    ...
    public function getActualFileName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getActualFileName', array());
    ...
    public function prepareSizes($doRewrite = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'prepareSizes', array($doRewrite));
    ...
    public function getBlurredImageData($width = NULL, $height = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBlurredImageData', array($width, $height));

        return parent::getBlurredImageData($width, $height);
    }
