...
--------------------------------------------------------------------
[Mon, 16 Apr 18 07:59:52 +0000]
[X-Cart v5.3.4.6]
[GET, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
Debug info
array (
)

--------------------------------------------------------------------
[Mon, 16 Apr 18 07:59:56 +0000]
[X-Cart v5.3.4.6]
[POST, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
Debug info
array (
  'params' => 
...
array (
  ...
  array (
    ...
    'status' => true,
    'critical' => false,
    'value' => 'libcurl 7.52.1, OpenSSL/1.0.2j',
    'data' => 
    array (
      'version' => 'libcurl 7.52.1, OpenSSL/1.0.2j',
    ),
    'messageData' => 
    array (
      ':version' => 'libcurl 7.52.1, OpenSSL/1.0.2j',
...
array (
  ...
  array (
    'mysqlhost' => 'localhost',
    'mysqlbase' => 'webshop PoC',
    'mysqluser' => 'root',
    'mysqlpass' => '<empty>',
    'demo' => 'Y',
    'mysqlport' => '3306',
    'mysqlsock' => '/Applications/MAMP/tmp/mysql/mysql.sock',
    'mysqlprefix' => 'xc_',
    'xlite_http_host' => 'localhost:8888',
    'xlite_https_host' => 'localhost:8888',
    'xlite_web_dir' => '',
...
[POST, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
Fatal error: Cannot connect to MySQL server. Make sure you specified correct user and password values.<span class="pdo-details" onclick="javascript: toggleSection('pdo-error');">See details</span><div class="section section-pdo-error">SQLSTATE[HY000] [1045] Access denied for user 'root'@'localhost' (using password: NO)</div><br />Click the 'BACK' button to review the MySQL server settings.


--------------------------------------------------------------------
[Mon, 16 Apr 18 08:18:37 +0000]
[X-Cart v5.3.4.6]
[POST, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
Debug info
...
[POST, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
Fatal error: Cannot connect to MySQL server. Make sure you specified correct user and password values.<span class="pdo-details" onclick="javascript: toggleSection('pdo-error');">See details</span><div class="section section-pdo-error">SQLSTATE[HY000] [1045] Access denied for user 'root'@'localhost' (using password: YES)</div><br />Click the 'BACK' button to review the MySQL server settings.


--------------------------------------------------------------------
[Mon, 16 Apr 18 08:21:55 +0000]
[X-Cart v5.3.4.6]
[POST, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
Debug info
...
[POST, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
The specified database "local" not found
...
[POST, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
The database "local" successfully created.


--------------------------------------------------------------------
[Mon, 16 Apr 18 08:42:15 +0000]
[X-Cart v5.3.4.6]
[GET, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
Debug info
...
[Mon, 16 Apr 18 08:42:16 +0000]
[X-Cart v5.3.4.6]
[GET, HTTP/1.1] http://localhost:8888:8888/install.php?target=install&action=dirs
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
Debug info
array (
  'target' => 'install',
...
--------------------------------------------------------------------
[Mon, 16 Apr 18 08:42:23 +0000]
[X-Cart v5.3.4.6]
[POST, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
inst_http_request() result
array (
  'url_request' => 'http://localhost:8888/check/for/clean/urls.html',
  ...
  PEAR2\HTTP\Request\Response::__set_state(array(
    ...
    PEAR2\HTTP\Request\Headers::__set_state(array(
       ...
       'fields' => 
      array (
        'Date' => 'Mon, 16 Apr 2018 08:42:23 GMT',
        ...
        'X-Powered' => 'PHP/7.2.1',
        'Set-Cookie' => 'xid=qlDHO9QepzefIYaQ6nXlqWLL29lmjEzX; path=/; HttpOnly',
        'Cache-Control' => 'max-age=0',
        'Expires' => 'Mon, 16 Apr 2018 08:42:23 GMT',
        'Content-Length' => '2',
    ...
    array (
     ...
     'uri' => 'http://localhost:8888/check/for/clean/urls.html',
  )),
  'response' => 'OK',
  'error' => NULL,
)
...
--------------------------------------------------------------------
[Mon, 16 Apr 18 08:42:24 +0000]
[X-Cart v5.3.4.6]
[POST, HTTP/1.1] http://localhost:8888:8888/install.php
[Apache/2.2.34 (Unix) mod_wsgi/3.5 Python/2.7.13 PHP/7.2.1 mod_ssl/2.2.34 OpenSSL/1.0.2j DAV/2 mod_fastcgi/2.4.6 mod_perl/2.0.9 Perl/v5.24.0]
Installation script renamed to install.02fac9ef37aec68710a49177179e4401.php
