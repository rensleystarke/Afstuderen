...
function processLazyLoadCachedImages(){$('.lazy-load:not(.lazy-load-bound)').each(function(){var wrapper=$(this),image=wrapper.find('img:first'),src=image.attr('src'),loaded=is_image_loaded(src);if(loaded)wrapper.removeClass('lazy-load lazy-load-bound')})}
